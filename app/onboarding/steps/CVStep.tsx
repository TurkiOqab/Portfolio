        ...
        <div className="space-y-8">
            ...
            <div className="flex flex-col items-center">
                ...
                <div className="relative mb-6">
                    <div className={`w-40 h-48 rounded-xl ${fileName ? 'bg-white/10 border-zinc-600' : 'bg-zinc-800 border-zinc-700'} border-2 border-dashed flex flex-col items-center justify-center transition-colors`}>
                        {isUploading ? (
